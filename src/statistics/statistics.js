...
class Statistics {
  ...
  #buildShot(attack, weaponShotLine) {
    ...
    const shot = new WeaponShot({
      ...
      hullDamage: shotParseResults.weaponStrength?.hullDamage ?? 0,
      shieldDamage: shotParseResults.weaponStrength?.shieldDamage ?? 0,
      energyDamage: shotParseResults.weaponStrength?.energyDamage ?? 0,
